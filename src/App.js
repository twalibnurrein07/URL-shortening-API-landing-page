  ...
  return (
    <><section id="section1">
        ...
        <div className="form">
          <form class="row g-2">
            ...
            <div class="col-lg-4 sm-12">
              <button type="submit" class="btn btn-primary btn-lg mb-3">Shorten it</button>
            </div>
          </form>
      ...
      <div className="statistics">
          ...
          <p>Track how your links are performing across the web with our advanced statistics board</p>
        </div>
